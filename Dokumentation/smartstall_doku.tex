...
%Ausblick: 
%Überwachung durch mehrere Sensoren
%Datenbankausbau
%Login Datenbank
%Schwellwert variabel einstellen durch Bauern (Überforderung?)
%An und Ausschalten der Steckdose durch Telegram?
