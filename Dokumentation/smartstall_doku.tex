...
Des weiteren wird die entwickelte Webanwendung vorgestellt. Dabei werden die Architektur, das Hosting, das Deployment, das Software-Design, dieaten, die Benutzeroberfläche, die Telegram-Anbindung und das Steuern der WLAN-Steckdose thematisiert. \\
